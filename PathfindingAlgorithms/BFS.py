"""
Breadth First Search, using a queue implementation.

Takes an input of an n x n matrix of integers, representing the distance between nodes on a graph.  Uses breadth first search to find a path from the node 1 to node n.
